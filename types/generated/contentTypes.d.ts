...
export interface ApiConfirmedCaseConfirmedCase extends Schema.CollectionType {
  ...
  attributes: {
    students: Attribute.Relation<
      'api::confirmed-case.confirmed-case',
      'manyToMany',
      'api::student.student'
    >;
    tutors: Attribute.Relation<
      ...
      'api::tutor.tutor'
    >;
    Starting_Month: Attribute.String & Attribute.Required;
    Fees: Attribute.Integer & Attribute.Required;
...
export interface ApiMediumMedium extends Schema.CollectionType {
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tutors: Attribute.Relation<
      ...
      'api::tutor.tutor'
    >;
    confirmed_cases: Attribute.Relation<
      'api::student.student',
      'manyToMany',
      'api::confirmed-case.confirmed-case'
    >;
...
export interface ApiTutorTutor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Qualification: Attribute.Blocks & Attribute.Required;
    Preferable_location: Attribute.Blocks;
    Address: Attribute.Blocks & Attribute.Required;
    subjects: Attribute.Relation<
      'api::tutor.tutor',
      'manyToMany',
      'api::subject.subject'
    ...
    classes: Attribute.Relation<
      ...
      'api::class.class'
    >;
    confirmed_tutors: Attribute.Relation<
      'api::tutor.tutor',
      'manyToMany',
      'api::confirmed-case.confirmed-case'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::confirmed-case.confirmed-case': ApiConfirmedCaseConfirmedCase;
